...
@push('scripts')
    <script>
        ...
        function printTable() {
            const printArea = document.getElementById('printTable');
            const originalBody = document.body.innerHTML;

            // destroy datatable biar ke-print normal
            ...
            document.body.innerHTML = kopSurat + printArea.innerHTML;
            window.print();
            document.body.innerHTML = originalBody;

            // re-init datatable setelah print
            location.reload();
        }
