...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="td-2">:</td>
            <td class="td-3">Rp <div class="float-end">
                    {{ number_format($transaksi->layanan->harga_layanan, 0, ',', '.') }}</div>
            </td>
        </tr>
    </table>
    <div class="divider"></div>
    <table>
        <tr>
            ...
            <td class="td-2">:</td>
            <td class="td-3">Rp <div class="float-end">
                    {{ number_format($transaksi->layanan->harga_layanan * $transaksi->berat, 0, ',', '.') }}</td>
        </tr>
        <tr>
            <td class="td-1">Jumlah Bayar</td>
            <td class="td-2">:</td>
            <td class="td-3">Rp <div class="float-end">{{ number_format($transaksi->jumlah_bayar, 0, ',', '.') }}
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-2">:</td>
            <td class="td-3">Rp <div class="float-end">
                    {{ number_format($transaksi->jumlah_bayar - $transaksi->layanan->harga_layanan * $transaksi->berat, 0, ',', '.') }}
                </div>
            </td>
        </tr>
    </table>
